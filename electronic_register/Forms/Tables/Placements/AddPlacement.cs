...
namespace electronic_register
{
    public partial class AddPlacement : Form
    {
        ...
        private void InitEditInfo()
        {
            ...
            //comboBox_block.SelectedValue = int.Parse(data["typeId"].ToString());
            //comboBox_floor.SelectedValue = int.Parse(data["typeId"].ToString());
            //comboBox_room.SelectedValue = int.Parse(data["roomId"].ToString());
